...
var g = (n, e, t) => (be(n, typeof e != "symbol" ? e + "" : e, t), t);
...
const Oe = ["onKeypress"], ke = { class: "m-fullscreen-img-scroller" }, Pe = ["src", "alt"], Se = /* @__PURE__ */ oe({
  ...
  setup(n, { emit: e }) {
    const t = e, s = _(() => import("./MazSpinner-BKjRRWtc.mjs")), r = _(() => import("./x-mark-BP8zWe_C.mjs")), f = _(() => import("./chevron-left-CcZaP3Rc.mjs")), i = n, v = y(!1), C = y(!1), w = y(!1), m = y(!1), d = y(!1), c = y(i.clickedElement), u = E(() => i.clickedElement.getBoundingClientRect()), re = E(
    ...
    async function de(o, a) {
      o.classList.remove(i.openInstanceClass), a.classList.add(i.openInstanceClass);
    ...
    function N(o) {
      ...
      if (a) {
        const l = V(), h = l.indexOf(a), I = o === "next" ? h + 1 : h - 1, p = l[me(l, I)];
        c.value = p, p && de(a, p), t(o), d.value ? Y(z.value) : H();
      }
    }
    function Y(o) {
    ...
    function H() {
      const { centerX: o, centerY: a, originalHeight: l, originalWidth: h, scale: I } = X(), p = {
        top: `${a}px`,
        left: `${o}px`,
        width: `${h * I}px`,
        height: `${l * I}px`
    ...
    return Ie(() => {
      ...
      w.value && m.value ? (b(), A("button", {
        ...
        onClick: a[0] || (a[0] = P((l) => N("next"), ["stop"]))
      }, [
      ...
      w.value && m.value ? (b(), A("button", {
        ...
        onClick: a[1] || (a[1] = P((l) => N("previous"), ["stop"]))
      }, [
      ...
      k("div", ke, [
        ...
        k("img", {
          ...
          class: F([ie.value]),
          onLoad: le,
          onClick: a[2] || (a[2] = P((l) => o.zoom ? he() : void 0, ["stop"]))
        }, null, 42, Pe)
      ])
    ], 40, Oe));
  }
  ...
  for (const [s, r] of e)
    t[s] = r;
  return t;
}, He = /* @__PURE__ */ ae(Se, [["__scopeId", "data-v-d975dba3"]]);
function Be(n, e) {
...
const Fe = {
  ...
  setup(n) {
    Ce((m) => ({
      "372f679d": n.separatorColor
    }));
    const e = _(() => import("./no-photography-CFaiDNTH.mjs")), t = n;
    ze(() => {
...
}), qe = /* @__PURE__ */ ae(We, [["__scopeId", "data-v-bfd5041a"]]);
export {
  qe as M,
  ae as _
};
